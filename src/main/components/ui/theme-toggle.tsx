  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className={cn("cursor-pointer flex items-center justify-center rounded-base outline-none border-none text-subtext hover:text-foreground w-8.5 h-8.5", withBox && "bg-primary-foreground")}>
          {themeIcons.light}
          {themeIcons.dark}
